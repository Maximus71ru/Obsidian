...
- Открыта
- я (правая) квадр. Скобка - подвинуть правый край слоя до маркера (с Alt подрезается
...
Сохранение проекта с файлами - путь по меню: file \ Dependenies \ Collect Files...

Очистка кеша: Edit \ Preferenes \ Media & Dick Cache...

Вопросы:
Прекомпозиция, для чего нужна?
